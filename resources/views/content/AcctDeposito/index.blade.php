...
<div class="card border border-dark mt-5">
    <div class="card-header bg-dark clearfix">
        ...
        <div class="form-actions float-right">
            <a href="{{ route('AcctDeposito.create') }}" class="btn btn-sm btn-info"><i class="fa fa-plus"></i> Tambah
                Kode simp berjangka</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <table id="example" style="width:100%"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align:center'>{{ $acct_deposito->deposito_number }}</td>
                        <td style='text-align:center'>{{ $acct_deposito->account_id }}</td>
                        <td style='text-align:center'>{{ $acct_deposito->account_basil_id }}</td>
                        ...
                        <form action="{{ route('AcctDeposito.delete', $acct_deposito->deposito_id) }}" method="post">
                            @csrf
