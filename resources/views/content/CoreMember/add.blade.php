...
<script>
    $(document).ready(function() {
        // Saat provinsi dipilih, perbarui kabupaten
        $('#province_id').change(function() {
            var provinceId = $(this).val();
            $('#city_id').empty().append('<option value="">--- Pilih Salah Satu ---</option>');
            $('#kecamatan_id, #kelurahan_id, #dusun_id').empty().append('<option value="">--- Pilih Salah Satu ---</option>');
            if (provinceId) {
                $.ajax({
        ...
        // Saat kabupaten dipilih, perbarui kecamatan
        $('#city_id').change(function() {
            var cityId = $(this).val();
            $('#kecamatan_id').empty().append('<option value="">--- Pilih Salah Satu ---</option>');
            $('#kelurahan_id, #dusun_id').empty().append('<option value="">--- Pilih Salah Satu ---</option>');
            if (cityId) {
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(key, value) {
                            $('#kecamatan_id').append('<option value="'+ value.kecamatan_id +'">'+ value.kecamatan_name +'</option>');
                        });
                    }
                });
            }
        ...
        // Saat kecamatan dipilih, perbarui kelurahan
        $('#kecamatan_id').change(function() {
            ...
            if (kecamatanId) {
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(key, value) {
                            $('#kelurahan_id').append('<option value="'+ value.kelurahan_id +'">'+ value.kelurahan_name +'</option>');
                        });
                    }
                });
            }
        ...
        // Saat kelurahan dipilih, perbarui dusun
        $('#kelurahan_id').change(function() {
            ...
            if (kelurahanId) {
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(key, value) {
                            $('#dusun_id').append('<option value="'+ value.dusun_id +'">'+ value.dusun_name +'</option>');
                        });
                    }
                });
            }
