        ...
        <div class="card-body">
            <form action="{{ route('core_province.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="province_code" name="province_code" required maxlength="2"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="province_name" name="province_name" required
                        maxlength="255" placeholder="Masukkan nama provinsi">
                </div>
                <div class="form-group">
                    <label for="province_no">Nomor Provinsi</label>
                    <input type="text" class="form-control" id="province_no" name="province_no" maxlength="20"
