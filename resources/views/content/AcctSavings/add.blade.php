...
@section('content')
@if(Session::has('success')) < div class="alert alert-success alert-dismissible mt-5"> <button type="button"
        class="close" data-dismiss="alert" aria-hidden="true">×</button>
    <h4>
        <i class="icon fa fa-check"></i>
        {{ Session::get('success') }}
    </h4>
    < /div> @endif @if (Session::has('warning')) <div class="alert alert-warning alert-dismissible mt-5">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h4>
            <i class="icon fa fa-check"></i>
            {{ Session::get('warning') }}
        </h4>
        < /div> @endif @if (Session::has('danger')) <div class="alert alert-danger alert-dismissible mt-5">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
            <h4>
                <i class="icon fa fa-check"></i>
                {{ Session::get('danger') }}
            </h4>
            < /div> @endif <div class="card border border-dark mt-5">
                ...
                <div class="card-body">
                    <form action="{{ route('AcctSavings.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="savings_code">Kode Simpanan
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="savings_code" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="savings_name">Nama Simpanan
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="savings_name" class="form-control" required="required">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <button class="btn btn-success mt-4" type="button" id="addRowBtn">+ Tambah Nomor
                                        Perkiraan Baru</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="savings_nisbah">Nisbah
                                        <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="savings_basil">Bagi Hasil
                                        <span class="text-danger">*</span>
                                    </label>
                ...
                <script>
                    document
                        ...
                        .addEventListener('click', function () {
                            ...
                            "{{ url('/acct_account/add') }}"; // Mengarahkan ke URL yang diinginkan
                        });
                    ...
                    document
                        .getElementById('formNomorPerkiraan')
