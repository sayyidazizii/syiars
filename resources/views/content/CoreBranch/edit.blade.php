...
@section('content') < div class = "col-md-6" > <div class="box box-primary">
    <form
        role="form"
        method="post"
        action="{{ route('core_branch.prosesupdate', $core_branch->branch_id) }}">
        @csrf
        <div class="box-body">
            <div class="form-group">
                ...
                <input
                    ...
                    name="branch_code"
                    class="form-control"
                    value="{{$core_branch->branch_code}}"></div>
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="branch_name"
                        class="form-control"
                        value="{{$core_branch->branch_name}}"></div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="branch_city"
                            class="form-control"
                            value="{{$core_branch->branch_city}}"></div>
                        <div class="form-group">
                            ...
                            <input
                                ...
                                class="form-control"
                                value="{{$core_branch->branch_contact_person}}"></div>
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="branch_email"
                                    class="form-control"
                                    value="{{$core_branch->branch_email}}"></div>
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        name="branch_phone1"
                                        class="form-control"
                                        value="{{$core_branch->branch_phone1}}"></div>
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="branch_phone2"
                                            class="form-control"
                                            value="{{$core_branch->branch_phone2}}"></div>
