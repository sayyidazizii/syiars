                        ...
                        <table id="example" style="width:100%"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style='text-align:center'>{{ $acct_deposito->account->account_code }}-{{ $acct_deposito->account->account_name }}</td>
                                    <td style='text-align:center'>{{ $acct_deposito->account_id }}</td>
                                    <td style='text-align:center'>{{ $acct_deposito->account->account_name }}</td>
