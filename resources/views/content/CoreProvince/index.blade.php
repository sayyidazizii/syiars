                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-outline-warning btn-sm mb-2" href="{{ route('core_province.update', $province->id) }}">Edit</a>
                            <form action="{{ route('core_province.delete', $province->id) }}" method="POST" class="d-inline">
                                @csrf
