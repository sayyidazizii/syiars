...
@section('content') < div class = "col-md-6" > <div class="box box-primary">
    <form
        role="form"
        method="post"
        action="{{ route('acct_account.prosesupdate', $acct_account->id) }}">
        @csrf
        <div class="box-body">
            <div class="form-group">
                ...
                <input
                    ...
                    name="account_code"
                    class="form-control"
                    value="{{$acct_account->account_code}}"></div>
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="account_name"
                        class="form-control"
                        value="{{$acct_account->account_name}}"></div>
                    <div class="form-group">
                        ...
                        <input
                            ...
                            name="account_group"
                            class="form-control"
                            value="{{$acct_account->account_group}}"></div>
                        <div>
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <select name="account_type_id" id="account_type_id" class="form-control">
                                    ...
                                    <option
                                        data-kt-flag="{{ $key }}"
                                        value="{{ $key }}"
                                        {{ $key === old('account_type_id', '' ?? '') ? 'selected' :'' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
