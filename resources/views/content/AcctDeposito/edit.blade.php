            ...
            <form role="form" method="post" action="{{ route('AcctDeposito.prosesupdate', $acct_deposito->deposito_id) }}">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="deposito_code">Kode Berjangka</label> <input type="text" name="deposito_code"
                            class="form-control @error('deposito_code') is-invalid @enderror"
                            value="{{ old('deposito_code', $acct_deposito->deposito_code) }}"
                            placeholder="Masukkan kode berjangka" required="required">
                        @error('deposito_code')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deposito_name"
                            ...
                            placeholder="Masukkan nama deposito" required="required">
                        @error('deposito_name')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="deposito_number"
                            ...
                            placeholder="Masukkan nomor deposito" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <select id="account_id" name="account_id"
                            ...
                            <option value="1"
                                {{ old('account_id', $acct_deposito->account_id) == '1' ? 'selected' : '' }}>Deposito 1
                            </option>
                            <option value="2"
                                {{ old('account_id', $acct_deposito->account_id) == '2' ? 'selected' : '' }}>Deposito 2
                            </option>
                            <option value="3"
                                {{ old('account_id', $acct_deposito->account_id) == '3' ? 'selected' : '' }}>Deposito 3
                            </option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="account_basil_id" name="account_basil_id"
                            ...
                            <option value="">Pilih nomor deposito</option>
                            <option value="1"
                                {{ old('account_basil_id', $acct_deposito->account_basil_id) == '1' ? 'selected' : '' }}>
                                Deposito 1</option>
                            <option value="2"
                                {{ old('account_basil_id', $acct_deposito->account_basil_id) == '2' ? 'selected' : '' }}>
                                Deposito 2</option>
                            <option value="3"
                                {{ old('account_basil_id', $acct_deposito->account_basil_id) == '3' ? 'selected' : '' }}>
                                Deposito 3</option>
                            <!-- Add more options as needed -->
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deposito_period"
                            ...
                            placeholder="Masukkan jangka waktu" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="deposito_profit_sharing"
                            ...
                            placeholder="Masukkan bagi hasil/th " required="required">
