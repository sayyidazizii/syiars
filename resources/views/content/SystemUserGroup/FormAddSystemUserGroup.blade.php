...
@section('content')
    <form method="post" action="{{ route('system-user-group.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="user_group_name" class="text-dark">Nama Group <span class="text-danger">*</span></label>
        ...
        @foreach ($systemmenu as $val)
            <div
                class="{{ $val['indent_level'] == 1 ? 'indent_first' : ($val['indent_level'] == 2 ? 'indent_second' : 'indent_third') }}">
