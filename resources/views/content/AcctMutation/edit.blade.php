                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mutation_code" name="mutation_code"
                                value="{{ old('mutation_code', $acct_mutation->mutation_code) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="mutation_name">Nama Mutasi <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="mutation_name" name="mutation_name"
                                value="{{ old('mutation_name', $acct_mutation->mutation_name) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mutation_function" name="mutation_function"
                                value="{{ old('mutation_function', $acct_mutation->mutation_function) }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="mutation_status" name="mutation_status" required>
                                <option value="Debit" {{ $acct_mutation->mutation_status == 'Debit' ? 'selected' : '' }}>
                                    Debit</option>
                                <option value="Kredit" {{ $acct_mutation->mutation_status == 'Kredit' ? 'selected' : '' }}>
                                    Kredit</option>
                            </select>
                        </div>
                    </div>
