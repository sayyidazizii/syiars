...
@section('content') < div class = "col-md-6" > <div class="box box-primary">
    <form
        role="form"
        method="post"
        action="{{ route('acct_credit.prosesupdate', $acct_credits->id) }}">
        @csrf
        <div class="box-body">
            <div class="form-group">
                ...
                <input
                    ...
                    name="credits_code"
                    class="form-control"
                    value="{{$acct_credits->credits_code}}"></div>
                <div class="form-group">
