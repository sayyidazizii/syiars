...
<form method="post" action="{{ route('system-user-group.store') }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <a class="text-dark">Nama Group<a class="text-danger"> *</a></a>
        <input class="form-control input-bb" type="text" name="user_group_name" id="user_group_name" value=""/>
    </div>
    
    <button onclick="check_all()" class="btn btn-sm btn-info" title="Check All">Check All</button>
    <button onclick="uncheck_all()" class="btn btn-sm btn-info" title="Uncheck All">Uncheck All</button>
